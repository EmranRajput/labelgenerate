        ...
        <div class="container-fluid">
            <div class="main-menu-content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <div class="logo-box">
                            <a href="#" class="logo"><img src="{{asset('frontend/images/logo1.png')}}" style="width: 150px;" alt="logo"></a>
                    ...
                    <div class="col-lg-10">
                        <div class="menu-wrapper">
                            ...
                            <nav class="main-menu">
                                <ul>
                                    <li>
                                        <a href="#" class="red-btn-home">HOME </a>
                            ...
                            <div class="nav-right-button">
                                <a href="admission.html" class="btn theme-btn d-none d-lg-inline-block"><i class="la la-user-plus mr-1"></i> SINGUP</a>
        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="footer-item">
                    <a href="#">
                        <img src="{{asset('frontend/images/logo1.png')}}" alt="footer logo" style="width: 200px;" class="footer__logo">
                    </a>
